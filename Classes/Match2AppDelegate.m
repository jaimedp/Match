...
#import "Match2AppDelegate.h"
#import "Match2ViewController.h"

@implementation Match2AppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    viewController = [[Match2ViewController alloc]init];
...
-(void)netService:(NSNetService*)sender didNotPublish:(NSDictionary*)errors {
    NSLog(@"service DID NOT Publish: %@ -> %@", sender, errors);
}
